const taxSamplePaper3 = [
  ...
  // --- Q2 -------------------------------------------------------------------
  {
    ...
    marks: 1,
    questionText:
      "In November 2025 Mitch Brady purchased a new house, constructed by an approved contractor, for €325,000. He paid a deposit of €45,000 and secured a mortgage with a qualifying lender for the balance. Mitch is a first-time buyer.\n\n" +
  ...
  // --- Q3 -------------------------------------------------------------------
  {
    ...
    questionText:
      ...
      "Calculate the total non-refundable tax credits and the total refundable tax credits that Desmond and Jen can avail of for the tax year 2025.\n\n" +
      "Your answers should be entered as positive values.",
    parts: [
      {
  ...
  // --- Q16 ------------------------------------------------------------------
  {
    ...
    questionText:
      ...
      "Operating expenses:\n" +
      "  Wages & salaries (Note 1):           €95,000\n" +
      "  Rates:                               €4,000\n" +
      "  Depreciation:                        €3,750\n" +
      "  Light & heat:                        €7,300\n" +
      "  Motor expenses (Note 2):             €6,210\n" +
      "  Professional fees (Note 3):          €14,700\n" +
      "  Interest (Note 4):                   (€172)\n" +
      "  Advertising & marketing (Note 5):    €1,400\n" +
      "  Other expenses (Note 6):             €1,800\n" +
      "  Total expenses:                      €133,988\n\n" +
      "Profit before tax:                     €296,012\n\n" +
      "Notes:\n\n" +
      "1. Wages & salaries include €10,000 of statutory redundancy payments made to an employee and €2,500 of a pension accrual.\n\n" +
      "2. Motor expenses:\n" +
      "   Running costs for commercial van:        €1,540\n" +
      "   Leased car for managing director:        €4,670\n" +
      "   The leased car has a list price of €28,000 and CO2 emissions of 136g/km. The MD's business use is approximately 25%.\n\n" +
      "3. Professional fees:\n" +
      "   Accounting fees:                         €5,100\n" +
      "   Legal fee re: damage to a client's property: €2,400\n" +
      "   Architect's fee re: office extension work:   €7,200\n\n" +
      "4. Interest:\n" +
      "   Bank charges:                            €138\n" +
      "   Interest receivable from UK deposit account: (€310)\n\n" +
      "5. Advertising & marketing: €500 magazine/radio advertisements + €900 entertaining potential customers.\n\n" +
      "6. Other expenses:\n" +
      "   Website running costs:                   €700\n" +
      "   Christmas hampers for suppliers:         €80\n" +
      "   Donation to the Vincent de Paul Christmas Appeal: €150\n" +
      "   Staff Christmas party:                   €870\n\n" +
      "Calculate the Total Corporation Tax Payable for JUMBO JIM for the year ended 31 December 2025.",
    correctAnswer: 38947,
    tolerance: 0,
  },
  ...
  // --- Q23 ------------------------------------------------------------------
  {
    ...
    options: {
      ...
      D: "Where an employer provides free or subsided childcare, either in-house or externally at an independent facility, a taxable benefit arises",
    },
    correctAnswer: ["B", "D"],
  },
  ...
  // --- Q24 ------------------------------------------------------------------
  {
    ...
    marks: 2,
    questionText:
      "Anne owns a make-up shop and incurs some expenses in April 2025. She is unsure whether she can recover VAT on these expenses. Anne wants advice to understand whether VAT is recoverable on the following:\n\n" +
  ...
  // --- Q28 ------------------------------------------------------------------
  {
    ...
    marks: 5,
    questionText:
      "Ger Delaney (61 years old) is a proprietary director of Red Brick Limited, a company that prepares its accounts to 31 December each year. Ger is in receipt of the following income and benefits in 2025:\n\n" +
      "Note 1 — Salary & Bonus:\n" +
      "He receives an annual salary of €71,000. The board agreed at a meeting on 15 February 2026 that Ger should receive a bonus of €21,000 in respect of the year ended 31 December 2025. Ger's bonus was posted to the accounts on 17 January 2026, but he did not receive it until 25 February 2026.\n\n" +
      "Note 2 — Company Car:\n" +
      "He is provided with a company car. The original market value of the car is €38,000 and the CO2 emissions are 156g/km. The company also pays for all petrol for the car. Ger paid €125 per month for use of the car during 2025. Ger's annual business usage is 20,000 km.\n\n" +
      "Note 3 — Deposit Interest:\n" +
      "Irish deposit interest of €80.40 on which DIRT has been deducted.\n\n" +
      "Note 4 — Dividends:\n" +
      "Irish dividends of €7,500 (net).\n\n" +
      "Note 5 — Pension:\n" +
      "He contributes 4% of his annual salary to the company's occupational pension scheme and his employer matches that contribution.\n\n" +
  ...
  // --- Q29 ------------------------------------------------------------------
  {
    ...
    marks: 2,
    questionText:
      "Jude is the managing director of Knit Knot Limited, a trading company in which he owns all of the shares. Jude is a single father and earned a salary of €68,000 in 2025.\n\n" +
  ...
  // --- Q31 ------------------------------------------------------------------
  {
    ...
    questionText:
      ...
      "Denis incurred marketing and advertising fees of €210 in August to find a new tenant. The new tenant moved in from 1 September 2025.\n\n" +
      "The new monthly rent is €2,400 from 1 September. The tenant was looking for work in Kilkenny and as a gesture of goodwill, Denis allows the tenant to pay the rent monthly in arrears for the first six months of the lease. The tenant pays the rent on the 24th day after the month the rent was due.\n\n" +
      "Repairs on this property were €1,730 for the year. €510 of these repairs were incurred during August when the property was vacant. Included in this amount was some furniture and fittings which was installed in the house in August at a cost of €395. Property management fees for this property are €205 per month and house insurance for the calendar year is €400.\n\n" +
  ...
  // --- Q32 ------------------------------------------------------------------
  {
    ...
    marks: 2,
    questionText:
      "Morris works for Moby Limited and earned €650 per week. Morris is paid weekly. Moby Limited has the most up to date Revenue Payroll Notification (RPN) for Morris on file.\n\n" +
  ...
  // --- Q33 ------------------------------------------------------------------
  {
    ...
    marks: 2,
    questionText:
      "Fintan is studying for a master's in software engineering in UCD. While he is studying, he works part time in the local supermarket. Fintan's cousin, Bernie has told him of a project coming up in the company she works for, Small Steps Limited.\n\n" +
  ...
  // --- Q34 ------------------------------------------------------------------
  {
    ...
    marks: 6,
    questionText:
      "Juanita bought development land worth €10,000 in 1971. The market value of the land on 6 April 1974 was €32,000. The current use value (CUV) of the land on this date was €19,000. In January 1988, Juanita carried out enhancement works in the form of drainage works on the land costing €8,000. Juanita sold the land in June 2025 for €235,000. The CUV of the land on the date of sale was €150,000. Juanita had no other disposals in 2025.\n\n" +
      "Calculate the capital gains tax (CGT) payable by Juanita on the sale of the land in 2025.\n\n" +
      "Note: The indexation factor for 1974/75 is 7.528. The indexation factor for 1988/89 is 1.503.",
    correctAnswer: 23000,
    tolerance: 0,
  },
  ...
  // --- Q35 ------------------------------------------------------------------
  {
    ...
    marks: 2,
    questionText:
      "Where a principal contractor makes a payment to an individual with whom they have a relevant contract with which to carry out relevant operations, the principal contractor is obliged to deduct RCT from the payment to the sub-contractor.\n\n" +
    ...
    options: {
      ...
      C: "The principal contractor is not required to notify Revenue that they are making payments under the contract to the sub-contractor when the sub-contractor's tax affairs are up to date",
  ...
  // --- Q38 ------------------------------------------------------------------
  {
    ...
    marks: 2,
    questionText:
      "Leafy Limited commenced to trade on 1 January 2025. It makes up its first set of accounts to the year end 31 December 2025.\n\n" +
      "Trading profits for the year end 31 December 2025 amounted to €162,000. Leafy Limited hired four employees during the first year of trading.\n\n" +
      "Total employer PRSI paid to its four employees equals €20,800, made up as follows:\n\n" +
      "  Employee 1:    €3,000\n" +
      "  Employee 2:    €4,500\n" +
      "  Employee 3:    €6,200\n" +
      "  Employee 4:    €7,100\n\n" +
      "Calculate the corporation tax Leafy Limited has to pay in 2025.",
    correctAnswer: 2750,
    tolerance: 0,
  },
